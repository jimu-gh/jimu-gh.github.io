(function($){
  $(function(){
    ...
    $("#submsg").typed({
        strings: [":^500)","^4400Full Stack Web Developer<br>(RESTful Apps)","Data Enthusiast With Strong Focus On UI/UX","Service-oriented Entrepreneur","Forward-thinking Power Learner","Python, Radiohead, And Sushi Lover","Trilingual Language Specialist","Result-driven ENFJ Protagonist","Self-Proclaimed Music Otaku","Unabashed Laker Fan"],
        typeSpeed: 33,
        startDelay: 3000,
        backSpeed: 0,
        loop:true,
